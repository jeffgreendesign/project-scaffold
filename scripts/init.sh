...
# Version floor check (if configured)
...
- **[Tool] over [Alternative]**: [Reason]
- **Version floor enforcement**: `scripts/version-floor-check.sh` checks installed versions against `config/version-floors.json`. Do not downgrade framework versions without checking the floors file first.
...
write_file 'config/version-floors.json' << 'SCAFFOLD_EOF_CONFIG_VERSION-FLOORS_JSON_7f3d9a'
{
  "_comment": "Minimum safe versions for dependencies with known critical CVEs. Update when new advisories drop.",
  "_updated": "2026-03-01",
  "floors": {
    "next": {
      "reason": "CVE-2025-66478 (RCE), CVE-2025-29927 (auth bypass), CVE-2025-55184 (DoS), CVE-2026-23864 (DoS)",
      "minimums": {
        "14": "14.2.35",
        "15.0": "15.0.8",
        "15.1": "15.1.12",
    ...
    "react-server-dom-webpack": {
      "reason": "CVE-2025-55182 (RCE, CVSS 10.0), CVE-2026-23864 (DoS)",
      "minimums": {
        "19.0": "19.0.4",
        "19.1": "19.1.5",
        "19.2": "19.2.4"
    ...
    "next-mdx-remote": {
      "reason": "CVE-2026-0969 (arbitrary code execution). Vercel blocks deploys of < 6.0.0.",
      "minimums": {
        "*": "6.0.0"
      }
    }
...
SCAFFOLD_EOF_CONFIG_VERSION-FLOORS_JSON_7f3d9a
...
write_executable 'scripts/version-floor-check.sh' << 'SCAFFOLD_EOF_SCRIPTS_VERSION-FLOOR-CHECK_SH_7f3d9a'
#!/bin/bash
# ============================================================================
...
SCAFFOLD_EOF_SCRIPTS_VERSION-FLOOR-CHECK_SH_7f3d9a
